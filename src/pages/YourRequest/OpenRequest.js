                ...
                <div className='row justify-content-center'>
                    <div className="row">
                      ...
                      <div className='Manage-right' >
                       ...
                       <h1 className='mb-4' style={{textAlign: 'left'}}>Your Open Request <span className="change-color">From Customers</span></h1>
                            ...
                            <div style={{border: '1px solid #e2d5d5', padding: '1rem', boxShadow: '0px 0px 15px rgba(0, 0, 0, 0.25)' }} className="d-flex align-items-center flex-wrap my-3">
                                ...
                                <div className="input-group mx-3 mp-input-div shadow-sm">
                                <p className='text-muted' style={{marginBottom: '0px'}}>Customer ID</p>
                            ...
                            <table>
                                <tbody>
                                    ...
                                    <td style={{width: '550px'}} className='text-muted'>Bosch Gmbh<div className='text-muted small' >5468754</div></td>
